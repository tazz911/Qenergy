...
class FirebaseService {
  ...
  final FirebaseDatabase _rtdb = FirebaseDatabase.instanceFor(
    ...
    databaseURL: 'https://btech-91fce-default-rtdb.firebaseio.com',
  );
  ...
  Future<void> saveUserRealtime(String uid, String fullName, String email) {
    return _rtdb.ref('users/$uid').set({
      'user_id': uid,
      'full_name': fullName,
      'email': email,
